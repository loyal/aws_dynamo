...
enum {
    ...
    AWS_KINESIS_CODE_INCOMPLETE_SIGNATURE=1,
    AWS_KINESIS_CODE_INTERNAL_FAILURE=2,
    AWS_KINESIS_CODE_INVALID_ACTION=3,
    AWS_KINESIS_CODE_INVALID_CLIENTTOKENID=4,
    AWS_KINESIS_CODE_INVALID_PARAMETER_COMBINATION=5,
    AWS_KINESIS_CODE_INVALID_PARAMETER_VALUE=6,
    AWS_KINESIS_CODE_INVALID_QUERY_PARAMETER=7,
    AWS_KINESIS_CODE_MALFORMED_QUERY_STRING=8,
    AWS_KINESIS_CODE_MISSING_ACTION=9,
    AWS_KINESIS_CODE_MISSING_AUTHENTICATION_TOKEN=10,
    AWS_KINESIS_CODE_MISSING_PARAMETER=11,
    AWS_KINESIS_CODE_OPT_IN_REQUIRED=12,
    AWS_KINESIS_CODE_REQUEST_EXPIRED=13,
    AWS_KINESIS_CODE_SERVICE_UNAVAILABLE=14,
    AWS_KINESIS_CODE_THROTTLING=15,
    AWS_KINESIS_CODE_VALIDATION_ERROR=16,
    /*Changeable*/
    AWS_KINESIS_CODE_SIZE=17,   
};

#define AWS_KINESIS_JSON_SEQUENCE_NUMBER "SequenceNumber"
#define AWS_KINESIS_JSON_SHARD_ID "ShardIh"
